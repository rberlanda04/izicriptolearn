...
const HIGHLIGHTS = [
  ...
  'Simulador de trade com dados reais da OKX',
  'Sem promessa de retorno — nem aqui, nem em lugar nenhum',
];
  ...
  return (
    <div className="grid lg:grid-cols-2 min-h-[calc(100vh-64px-1px)]">
      ...
      <div className="hidden lg:flex flex-col justify-between bg-ink text-on-dark-strong p-12 relative overflow-hidden">
        <div className="absolute -top-24 -right-16 w-80 h-80 bg-accent/20 rounded-full blur-3xl" aria-hidden="true" />
        ...
        <div className="relative z-10">
          <h2 className="font-[var(--font-display)] text-3xl font-extrabold leading-tight max-w-sm text-on-dark-strong">
            Cripto explicado do jeito que devia ser: claro e honesto.
          </h2>
      ...
      <div className="flex items-center justify-center px-6 py-16">
        <div className="w-full max-w-sm">
          ...
          <p className="text-muted text-sm mt-1.5 mb-8">Acesse sua conta para continuar de onde parou.</p>
